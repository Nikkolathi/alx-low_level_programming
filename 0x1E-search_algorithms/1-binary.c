...
/**
 * binary_search - function that searches for array value in array sorted array of integers using Binary search algorithm.
 * @array: pointer to the first element of the array to search in @size: number of elements in array.
 * @value: value to search for You can assume that value won’t appear more than once in array.
